    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="pointer-events-none absolute -top-px left-1/2 h-[2px] rounded-full"
          style={{
        ...
        >
          {/* Undo/Redo */}
          <motion.div variants={groupVariants} className="flex items-center gap-1 pr-2 border-r border-[#333]">
            <ToolbarBtn
              icon={<Undo size={14} />}
          ...
          {/* Headings & Paragraph */}
          <motion.div variants={groupVariants} className="flex items-center gap-1 px-2 border-r border-[#333]">
            <ToolbarBtn
              icon={<Type size={14} />}
