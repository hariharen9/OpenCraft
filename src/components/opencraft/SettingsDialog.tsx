            ...
            <div>
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <input
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter") setAccentColor(custom);
                  }}
                  placeholder="#hex"
              ...
              >
                <div
                  className={
                    ...
                    (syncCalendarTasks ? "bg-[#ff8a4c]/15 text-[#ff8a4c]" : "bg-[#333] text-[#666]")
                  }
                >
                  {syncCalendarTasks ? (
                ...
                <div
                  className={
                    ...
                    (syncCalendarTasks ? "bg-[#ff8a4c]" : "bg-[#444]")
                  }
                >
                  <div
                    className={
                      "h-4 w-4 rounded-full bg-white transition-transform " +
                      (syncCalendarTasks ? "translate-x-4" : "translate-x-0")
                    }
                  />
                </div>
              </button>
                ...
                <div className="rounded-lg bg-[#262626] p-4 ring-1 ring-[#333]">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="flex-1">
                      <div className="text-[14px] font-medium text-[#e0e0e0]">
                  ...
                  <div className="text-[12px] text-[#777] bg-[#1a1a1a] p-2.5 rounded-md border border-[#333]">
                    <span className="text-[#34d399] mr-1">●</span> Sync is active. Your documents,
                    tasks, and workspaces are safely backed up and synced across devices.
                  </div>
                </div>
              ) : (
                <div className="rounded-lg bg-[#262626] p-4 ring-1 ring-[#333]">
                  <div className="text-[12px] text-[#999] mb-4">
                    Sign in to sync your workspace securely to the cloud. You can continue using
                    OpenCraft entirely offline if you prefer.
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative flex items-center">
                      ...
                      <span className="flex-shrink-0 mx-3 text-[#666] text-[11px] uppercase tracking-wider">
                        Or
                      </span>
                      <div className="flex-grow border-t border-[#444]"></div>
                    </div>
